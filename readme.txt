...
= 1.4.13 =
* Video Lightbox Button and Video Slideshow widgets: private and unlisted Vimeo videos (links with a privacy hash, e.g. vimeo.com/ID/HASH or player.vimeo.com/video/ID?h=HASH) now play in the lightbox. The privacy hash was dropped when building the embed URL, and player.vimeo.com links were not recognized at all
